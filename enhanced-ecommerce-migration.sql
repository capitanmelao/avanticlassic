-- ===================================================================
-- ENHANCED E-COMMERCE MIGRATION FOR AVANTI CLASSIC - FIXED
-- Fixes: UUID vs INTEGER mismatch + Stripe 2025 enhancements + Syntax errors
-- Date: July 17, 2025
-- ===================================================================

-- ===================================================================
-- CORE E-COMMERCE TABLES (Fixed data types and syntax)
-- ===================================================================
...
-- ===================================================================
-- DATA CONVERSION: Releases to Products (Fixed INTEGER types)
-- ===================================================================

-- Function to convert releases to products (FIXED for INTEGER IDs)
...
DECLARE
    ...
    product_id INTEGER; -- Changed from uuid to INTEGER
    cd_price_id INTEGER; -- Changed from uuid to INTEGER
    sacd_price_id INTEGER; -- Changed from uuid to INTEGER
    vinyl_price_id INTEGER; -- Changed from uuid to INTEGER
    digital_price_id INTEGER; -- Changed from uuid to INTEGER
BEGIN
    ...
    LOOP
        ...
        INSERT INTO products (
            ...
            CASE 
                ...
                THEN ARRAY[release_record.cover_image_url]
                ELSE '{}'
            END,
...
BEGIN
    ...
    RAISE NOTICE '=== ENHANCED E-COMMERCE MIGRATION COMPLETED ===';
    ...
    RAISE NOTICE '';
    RAISE NOTICE 'Enhancements included:';
    ...
    RAISE NOTICE '- Improved retry logic for webhooks';
    RAISE NOTICE '- Complete RLS security policies';
    RAISE NOTICE '- Fixed syntax errors in constraints';
END $$;
...
COMMENT ON TABLE public.products IS 'Product catalog linking to releases with Stripe integration (fixed INTEGER IDs)';
