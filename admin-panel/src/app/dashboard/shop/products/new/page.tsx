...
export default function NewProductPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const nextSortOrder = maxSortOrder?.[0]?.sort_order ? maxSortOrder[0].sort_order + 1 : 1
    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="mb-8">
        ...
        <p className="mt-2 text-sm text-gray-700">
          Add a new product to your catalog with pricing and inventory settings.
        </p>
      </div>
              ...
              {formData.prices.map((price, index) => (
                <div key={index} className="border border-gray-200 rounded-lg p-4">
                  <div className="flex justify-between items-center mb-4">
                    <h4 className="text-sm font-medium text-gray-900">Price Variant {index + 1}</h4>
